...
namespace Drupal\proc\Entity\Element;
 ...
 */
class ProcProcEntityAutocomplete extends Textfield {
  ...
  public function getInfo() {
    ...
    $info['#element_validate'] = [[$class, 'validateProcEntityAutocomplete']];
    array_unshift($info['#process'], [$class, 'processProcEntityAutocomplete']);
   ...
   *   missing.
   */
  public static function processProcEntityAutocomplete(array &$element, FormStateInterface $form_state, array &$complete_form) {
    ...
    $key_value_storage = \Drupal::keyValue('proc_entity_autocomplete');
    if (!$key_value_storage->has($selection_settings_key)) {
      $key_value_storage->set($selection_settings_key, $selection_settings);
    }

    $element['#autocomplete_route_name'] = 'system.proc_entity_autocomplete';
  ...
  /**
   * Form element validation handler for proc_entity_autocomplete elements.
   */
  public static function validateProcEntityAutocomplete(array &$element, FormStateInterface $form_state, array &$complete_form) {
    $value = NULL;

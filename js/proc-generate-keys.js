    ...
    attach: function (context, settings) {
      once('procGenerateKeys', 'html', context).forEach(function (element) {
        ...
        function resetPassword() {
          $('#edit-password-confirm-pass1').val("");
          $('#edit-password-confirm-pass2').val("");
        }
        ...
        function validatePassword(pass, passConfirm, strenght) {
          ...
          if ($('.password-strength__text').text() != procJsLabels.proc_minimal_password_strenght) {
        ...
        $('#edit-submit').on(
          'click', async function (e) {
            ...
            let password_error = validatePassword(
              pass, 
              passConfirm,
              procJsLabels.proc_minimal_password_strenght
            );
